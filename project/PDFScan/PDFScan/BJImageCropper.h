...
@interface BJImageCropper : UIView {
    ...
    UIView *topLeftIndicator;
    UIView *topRightIndicator;
    UIView *bottomLeftIndicator;
    UIView *bottomRightIndicator;
...
@property CGRect unscaledCrop;
@property (nonatomic, retain) UIImage* image;
@property (nonatomic, retain, readonly) UIImageView* imageView;

@property BOOL use75PercentSize;
