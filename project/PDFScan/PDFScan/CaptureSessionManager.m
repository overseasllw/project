...
- (id)init {
	if ((self = [super init])) {
      ...
      //  [self.captureSession setOrientation:AVCaptureVideoOrientationPortrait];
...
{
	AVCaptureConnection *videoConnection = nil;
  //  videoConnection.videoOrientation=true;
   // NSLog(@"video orientation:  %d",videoConnection.videoOrientation);
	for (AVCaptureConnection *connection in [[self stillImageOutput] connections]) {
        
     //
        //    [videoConnection setVideoOrientation:[UIDevice currentDevice].orientation];
       // NSLog(@"new video orientation:  %d",[UIDevice currentDevice].orientation);
