...
-(void)setup {
    ...
    percentLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 78, 78)];
    [percentLabel setFont:[UIFont fontWithName:@"Futura-CondensedMedium" size:15]];
    [percentLabel setTextColor:[UIColor colorWithRed:0/255.0 green:0/255.0 blue:0/255.0 alpha:1.0]];
